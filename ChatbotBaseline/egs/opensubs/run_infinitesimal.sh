...
# use Anaconda
export PATH="/home/calee/anaconda3/bin:$PATH"
...
## data files
train_data=${CHATBOT_DATADIR}/opensubs_infinitesimal_data_train.txt
valid_data=${CHATBOT_DATADIR}/opensubs_infinitesimal_data_dev.txt
eval_data=${CHATBOT_DATADIR}/opensubs_infinitesimal_data_eval.txt
...
expdir=./exp/${modeltype}_${optimizer}_ee${enc_esize}_eh${enc_hsize}_de${dec_esize}_dh${dec_hsize}_dp${dec_psize}_bs${batch_size}_dr${dropout}_ld${learn_decay}_infinitesimal
