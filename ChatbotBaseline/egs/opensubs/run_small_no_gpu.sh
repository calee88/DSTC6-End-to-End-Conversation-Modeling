...
## data files
train_data=${CHATBOT_DATADIR}/opensubs_small_data_train.txt
valid_data=${CHATBOT_DATADIR}/opensubs_small_data_dev.txt
eval_data=${CHATBOT_DATADIR}/opensubs_small_data_eval.txt
